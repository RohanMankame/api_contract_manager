    ...
    return (
        <div className="bg-white shadow rounded-lg border border-gray-200 overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-200 flex justify-between items-center bg-gray-50">
                <div>
                    <h3 className="text-lg font-semibold leading-6 text-gray-900">{company_name || 'Unnamed Client'}</h3>
                    <p className="mt-1 text-sm text-gray-500">Client ID: <span className="font-mono text-gray-700">{displayId}</span></p>
                </div>
            ...
            <div className="px-6 py-5">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-1">
                        ...
                        <dd className="mt-1 text-sm text-gray-900 font-medium">{phone_number || 'N/A'}</dd>
                    </div>
